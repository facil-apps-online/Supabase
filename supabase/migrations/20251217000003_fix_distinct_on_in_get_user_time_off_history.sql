-- Migration to fix the get_user_time_off_history function by removing the redundant DISTINCT ON clause.
...
-- Then, create the function with the corrected logic (DISTINCT ON removed)
