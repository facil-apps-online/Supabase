-- Final version of activate_subscription RPC, using is_active as the source of truth
-- and deactivating old subscriptions.
...
BEGIN
    -- Steps 1-4: Get plan, country, and configuration info (same as before)
    ...
    -- 8. Insert the new subscription record, making it the only active one
    ...
    VALUES (
        p_tenant_id,
        v_pcc_id,
        true, -- This is now the only active subscription
        v_new_start_date,
        v_new_end_date,
        FALSE
    );
