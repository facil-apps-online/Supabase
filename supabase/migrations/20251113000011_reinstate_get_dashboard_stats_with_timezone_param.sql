-- Drop potentially conflicting function signatures from previous migrations
DROP FUNCTION IF EXISTS public.get_dashboard_stats(uuid);
DROP FUNCTION IF EXISTS public.get_dashboard_stats(uuid, uuid, uuid);

-- Re-create the function with the correct signature including the timezone parameter
