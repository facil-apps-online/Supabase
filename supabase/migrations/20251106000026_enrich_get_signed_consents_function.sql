-- Enrich get_signed_consents_for_attention with client and professional names
...
BEGIN
    ...
    SELECT
        ...
        (u.raw_user_meta_data->>'first_name' || ' ' || u.raw_user_meta_data->>'last_name') AS professional_name
    FROM
