-- Migration to fix the get_public_subscription_plans RPC function to use a LEFT JOIN.
-- Version: 20251104000011
...
BEGIN
    ...
    LEFT JOIN plan_configs pc ON sp.id = pc.plan_id -- FIXED: Changed to LEFT JOIN
