-- Migration to add social network data to the get_microsite_data RPC function
...
COMMENT ON FUNCTION public.get_microsite_data(text, text, uuid) IS 'Fetches all public data for a tenant''s microsite, now including tenant and branch social networks.';
