-- This migration refines the list_treatments RPC function's filtering logic for 'is_active'.
-- It uses an IF statement to conditionally apply the 'is_active' filter,
-- making the behavior more explicit and robust against potential subtle boolean logic issues.
