...
-- Reemplazamos la función para añadir un log de depuración en el campo 'notes'
...
BEGIN
    ...
    -- 2. Insertar la atención usando el total recalculado y añadiendo el debug a las notas
    INSERT INTO public.attentions (client_id, attention_datetime, notes, total_amount, tenant_id, branch_id, status)
    VALUES (p_client_id, p_attention_datetime, p_notes || ' -- DEBUG TOTAL: ' || v_recalculated_total::text, v_recalculated_total, p_tenant_id, p_branch_id, 'Confirmada')
