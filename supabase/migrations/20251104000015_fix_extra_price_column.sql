-- Migration to fix the column used for extra prices in the public plans RPC.
-- Version: 20251104000015
...
BEGIN
    ...
    current_tariffs AS (
        SELECT DISTINCT ON (pt.subscription_plan_id)
            ...
            -- FIXED: Use extra_unit_price instead of overage_unit_price
