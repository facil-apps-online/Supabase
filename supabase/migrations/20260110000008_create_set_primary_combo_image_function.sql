DROP FUNCTION IF EXISTS set_primary_combo_image(p_combo_id uuid, p_image_id uuid);

CREATE OR REPLACE FUNCTION set_primary_combo_image(p_combo_id uuid, p_image_id uuid)
RETURNS void
LANGUAGE plpgsql
SECURITY DEFINER
AS $$
