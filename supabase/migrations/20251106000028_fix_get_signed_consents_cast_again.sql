-- Fixes a bug in get_signed_consents_for_attention using jsonb_extract_path_text
...
BEGIN
    ...
    SELECT
        ...
        (jsonb_extract_path_text(u.raw_user_meta_data::jsonb, 'first_name') || ' ' || jsonb_extract_path_text(u.raw_user_meta_data::jsonb, 'last_name')) AS professional_name
    FROM
