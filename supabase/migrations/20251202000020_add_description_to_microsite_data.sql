-- Migration to add description to the get_microsite_data RPC function
...
COMMENT ON FUNCTION public.get_microsite_data(text, text, uuid) IS 'Fetches all public data for a tenant''s microsite, including social networks, branch coordinates, and descriptions.';
