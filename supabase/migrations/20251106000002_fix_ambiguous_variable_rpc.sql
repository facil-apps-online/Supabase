DROP FUNCTION IF EXISTS public.get_public_subscription_plans(uuid, uuid);
CREATE FUNCTION public.get_public_subscription_plans(p_country_id uuid, p_platform_id uuid)
RETURNS TABLE(
    plan_id uuid, 
    plan_name text, 
