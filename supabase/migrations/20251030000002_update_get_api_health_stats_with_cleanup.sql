...
BEGIN
    ...
    RETURN (
        ...
        SELECT json_build_object(
            ...
            'high_latency_requests', (SELECT COALESCE(count(*), 0) FROM high_latency_list),
            'high_latency_list', (SELECT COALESCE(json_agg(high_latency_list), '[]'::json) FROM high_latency_list),
