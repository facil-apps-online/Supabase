...
-- Recreate the RPC functions with explicit tenant_id parameter

-- list_consent_templates
CREATE OR REPLACE FUNCTION list_consent_templates(p_tenant_id uuid)
...
CREATE OR REPLACE FUNCTION get_consent_template(p_tenant_id uuid, p_id uuid)
RETURNS SETOF public.informed_consent_templates
LANGUAGE plpgsql
SECURITY DEFINER
AS $$
