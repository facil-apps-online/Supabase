...
-- Owner assignment kept, signature updated.
ALTER FUNCTION "public"."create_tenant_with_admin"(UUID, UUID, UUID, TEXT, TEXT, TEXT, UUID, TEXT, TEXT, TEXT, TEXT, NUMERIC, NUMERIC, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT) OWNER TO "postgres";
